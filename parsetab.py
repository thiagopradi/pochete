...
_lr_productions = [
  ...
  ('listacmd -> comando listacmd1','listacmd',2,'p_listacmd','parser.py',16),
  ('listacmd1 -> empty','listacmd1',1,'p_listacmd1','parser.py',20),
  ('listacmd1 -> listacmd','listacmd1',1,'p_listacmd1','parser.py',21),
  ('comando -> cmdatribui','comando',1,'p_comando','parser.py',25),
  ('comando -> cmdentrada','comando',1,'p_comando','parser.py',26),
  ('comando -> cmdsaida','comando',1,'p_comando','parser.py',27),
  ('comando -> cmdselecao','comando',1,'p_comando','parser.py',28),
  ('comando -> cmdrepeticao','comando',1,'p_comando','parser.py',29),
  ('listaidenti -> ID listaindenti1','listaidenti',2,'p_listaidenti','parser.py',33),
  ('listaindenti1 -> empty','listaindenti1',1,'p_listaindenti1','parser.py',37),
  ('listaindenti1 -> , listaidenti','listaindenti1',2,'p_listaindenti1','parser.py',38),
  ('listaexp -> expressao listaexp1','listaexp',2,'p_listaexp','parser.py',42),
  ('listaexp1 -> , listaexp','listaexp1',2,'p_listaexp1','parser.py',46),
  ('listaexp1 -> empty','listaexp1',1,'p_listaexp1','parser.py',47),
  ('cmdatribui -> listaidenti SIM_ATTR expressao ;','cmdatribui',4,'p_cmdatribui','parser.py',51),
  ('cmdentrada -> INPUT ( listaidenti ) ;','cmdentrada',5,'p_cmdentrada','parser.py',55),
  ('cmdsaida -> OUTPUT ( listaexp ) ;','cmdsaida',5,'p_cmdsaida','parser.py',59),
  ('cmdselecao -> IF expressao : [ listacmd ] elif else ;','cmdselecao',9,'p_cmdselecao','parser.py',63),
  ('elif -> empty','elif',1,'p_elif','parser.py',67),
  ('elif -> ELIF expressao : [ listacmd ] elif','elif',7,'p_elif','parser.py',68),
  ('else -> empty','else',1,'p_else','parser.py',72),
  ('else -> ELSE : [ listacmd ]','else',5,'p_else','parser.py',73),
  ('cmdrepeticao -> WHILE expressao : [ listacmd ] else ;','cmdrepeticao',8,'p_cmdrepeticao','parser.py',77),
  ('expressao -> valor expressao1','expressao',2,'p_expressao','parser.py',81),
  ('expressao1 -> empty','expressao1',1,'p_expressao1','parser.py',85),
  ('expressao1 -> OR valor expressao1','expressao1',3,'p_expressao1','parser.py',86),
  ('expressao1 -> AND valor expressao1','expressao1',3,'p_expressao1','parser.py',87),
  ('valor -> relacional','valor',1,'p_valor','parser.py',91),
  ('valor -> TRUE','valor',1,'p_valor','parser.py',92),
  ('valor -> FALSE','valor',1,'p_valor','parser.py',93),
  ('valor -> NOT valor','valor',2,'p_valor','parser.py',94),
  ('relacional -> aritmetica relacional1','relacional',2,'p_relacional','parser.py',98),
  ('relacional1 -> operador aritmetica','relacional1',2,'p_relacional1','parser.py',102),
  ('relacional1 -> empty','relacional1',1,'p_relacional1','parser.py',103),
  ('operador -> SIM_EQ','operador',1,'p_operador','parser.py',107),
  ('operador -> SIM_DIF','operador',1,'p_operador','parser.py',108),
  ('operador -> <','operador',1,'p_operador','parser.py',109),
  ('operador -> SIM_LE','operador',1,'p_operador','parser.py',110),
  ('operador -> >','operador',1,'p_operador','parser.py',111),
  ('operador -> SIM_GE','operador',1,'p_operador','parser.py',112),
  ('aritmetica -> termo aritmetica1','aritmetica',2,'p_aritmetica','parser.py',116),
  ('aritmetica1 -> empty','aritmetica1',1,'p_aritmetica1','parser.py',120),
  ('aritmetica1 -> + termo aritmetica1','aritmetica1',3,'p_aritmetica1','parser.py',121),
  ('aritmetica1 -> - termo aritmetica1','aritmetica1',3,'p_aritmetica1','parser.py',122),
  ('termo -> fator termo1','termo',2,'p_termo','parser.py',126),
  ('termo1 -> empty','termo1',1,'p_termo1','parser.py',130),
  ('termo1 -> * fator termo1','termo1',3,'p_termo1','parser.py',131),
  ('termo1 -> / fator termo1','termo1',3,'p_termo1','parser.py',132),
  ('termo1 -> % fator termo1','termo1',3,'p_termo1','parser.py',133),
  ('fator -> elemento fator1','fator',2,'p_fator','parser.py',137),
  ('fator1 -> empty','fator1',1,'p_fator1','parser.py',141),
  ('fator1 -> SIM_POT elemento fator1','fator1',3,'p_fator1','parser.py',142),
  ('elemento -> ID','elemento',1,'p_elemento','parser.py',146),
  ('elemento -> INTEIRO','elemento',1,'p_elemento','parser.py',147),
  ('elemento -> REAL','elemento',1,'p_elemento','parser.py',148),
  ('elemento -> LITERAL','elemento',1,'p_elemento','parser.py',149),
  ('elemento -> ( expressao )','elemento',3,'p_elemento','parser.py',150),
  ('elemento -> + elemento','elemento',2,'p_elemento','parser.py',151),
  ('elemento -> - elemento','elemento',2,'p_elemento','parser.py',152),
]
